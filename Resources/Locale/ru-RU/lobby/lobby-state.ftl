...
lobby-state-playtime-comment-concerning = Сегодня вы играете уже { $hours } часов. Пожалуйста, сделайте перерыв.
lobby-state-playtime-comment-grasstouchless = { $hours } часов. Задумайтесь о выходе из игры, чтобы заняться своими делами.
