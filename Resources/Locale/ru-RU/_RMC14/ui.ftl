...
rmc-ui-shoutout-nt-title = Имя для объявления Нанотрейзен в конце раунда.
rmc-ui-shoutout-nt-description = Отображается в конце раунда как "Нанотрейзен финансируется: " и ваше имя.
