...
traitor-role-moreinfo = Подробнее о вашей роли можно узнать в меню персонажа.
traitor-role-nouplink = У вас нет аплинка Синдиката. Постарайтесь обойтись без него.
