...
traitor-role-uplink-pen-code =
    Прокрутите ручку до кода [color = lightgray]{ $code }[/color], чтобы разблокировать аплинк.
    Градусы соответствуют углу поворота. Аплинк блокируется автоматически при закрытии.
...
traitor-role-uplink-pen-code-short = Код вашей ручки-аплинка: { $code }. Прокрутите ручку для разблокировки. Блокируется при закрытии.
traitor-role-uplink-implant-short = Ваш аплинк был имплантирован. Воспользуйтесь им из хотбара.
traitor-role-moreinfo = Найдите больше информации о вашей роли в меню персонажа.
traitor-role-nouplink = К сожалению, у вас нет доступа к аплинку.
traitor-role-allegiances = Ваши союзники:
