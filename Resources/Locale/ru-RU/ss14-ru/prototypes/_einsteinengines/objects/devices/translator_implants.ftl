...
ent-MofficTranslatorImplant = имплант "переводчик Моффик"
    .desc = Имплант, созданный для одомашнивания тараканомолей. Впоследствии позволяет общаться с Молями.
...
ent-GruntishTranslatorImplant = имплант переводчика грунтиша
    .desc = Имплант, дающий способность понимать и говорить на грантише.

ent-NewKinPidginTranslatorImplant = имплант переводчика ка'ракк
    .desc = Имплант, дающий способность понимать и говорить на ка'ракк.

ent-SchechiTranslatorImplant = имплант переводчика шшечи
    .desc = Имплант, дающий способность понимать и говорить на шшечи.
