...
ent-ClothingModsuitHelmetResponsorySecurity = шлем скафандра офицера ОБР
    .desc = Передовой шлем, разработанный Нанотрейзен для скафандра офицера ОБР. Имеет встроенный ИЛС.
ent-ClothingModsuitChestplateResponsorySecurity = нагрудная пластина скафандра офицера ОБР
    .desc = Передовой нагрудник, разработанный Нанотрейзен для скафандра офицера ОБР. Оснащён сервоприводами для снижения нагрузки.
