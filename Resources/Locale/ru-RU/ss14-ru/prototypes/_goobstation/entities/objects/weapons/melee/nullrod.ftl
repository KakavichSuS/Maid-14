...
ent-Bulwark = Бастион
    .desc = Абсолютно огромный двуручный щит, очень сложный в использовании, если не установлен на месте.

ent-RatvarianSpear = древнее копьё
    .desc = Древнее копьё из латуни, то есть золота, то есть бронзы. Выглядит очень механизированным.
