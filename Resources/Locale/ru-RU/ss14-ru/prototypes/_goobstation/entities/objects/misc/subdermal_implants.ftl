ent-BluespaceLifelineImplant = имплант блюспей Lifeline
    .desc = Телепортирует тело носителя на ЦентКом при активации. Вернуться он не сможет.
...
ent-ClumsyImplant = имплант неуклюжести
    .desc = Этот имплант делает носителя неуклюжим, позволяя управлять определённым транспортным средством.

ent-RedspaceLifelineImplant = имплант краснокосмической линии жизни
    .desc = Телепортирует тело носителя в Верховное Командование Синдиката при активации. Вернуться не получится.
ent-ShadowmindImplant = имплант теневого разума
    .desc = Этот имплант позволяет пользователю получить доступ к каналу Теневого Разума (используйте +q).
ent-XenoCompatibilityImplant = имплант ксено-совместимости
    .desc = Позволяет субъекту пересаживать ксено-органы.
