...
# Maid
ent-WeaponDisablerAdvanced = дизейблер ЦентКом
...
ent-WeaponDisablerSyndicate = дизейблер синдиката
    .desc = Продвинутый дизейблер, созданный на основе прототипа Нанотрейзен. Хоть ему и не хватает мощности, это компенсируется самозаряжающейся батареей.
# MaidEnd
