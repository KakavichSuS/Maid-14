...
ent-ServiceEnergyChemMachineCircuitboard = плата энергетического синтезатора еды
    .desc = Печатная плата для энергетического синтезатора еды.
ent-VirologyServerMachineCircuitboard = плата сервера вирусологии
    .desc = Печатная плата для сервера вирусологии.
