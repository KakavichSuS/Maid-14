...
ent-PinpointerContractor = контракторский пинпоинтер
    .desc = Ручное устройство слежения, указывающее на твой корабль и твою цель. Держи вертикально для сохранения точности.
