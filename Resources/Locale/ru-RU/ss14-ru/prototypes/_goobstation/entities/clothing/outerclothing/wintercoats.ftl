...
ent-ClothingOuterWinterCoatTrainer = пальто NCT
    .desc = Надёжное пальто, выданное тренерам карьеры Нанотрейзен. Отлично подходит для обучения новичков.
...
ent-ClothingOuterWinterCosmic = космическое зимнее пальто
    .desc = Дорогое машинное зимнее пальто.
