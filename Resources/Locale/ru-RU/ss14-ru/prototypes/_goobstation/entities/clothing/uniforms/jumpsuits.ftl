...
ent-ClothingUniformJumpsuitNanotrasenRepresentativeFancy = роскошный костюм представителя Нанотрейзен
    .desc = Роскошный чёрный костюм, носимый официальными лицами, украшенный золотыми нитями больше обычного.

ent-ClothingUniformJumpsuitWestern = ковбойский комбинезон
    .desc = Покажем начальнику охраны, как мы делали дела на диком западе.
