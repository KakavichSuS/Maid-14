...
ent-ClothingEyesGlassesSecurityContraDetect = контрабанд-детекторные очки охраны
    .desc = Очки, обеспечивающие защиту от вспышек, HUD охраны и встроенный детектор контрабанды.
