ent-PosterLegitGoobWorkHard = Работай усердно
    .desc = Если будешь работать достаточно усердно, ТЫ сможешь получить собственный Нанотрейзен Plunger Plus! Только выживи достаточно долго, чтобы забрать его!..
...
ent-PosterLegitGoobSuperMatter = Супер-материя
    .desc = Нанотрейзен становится всё креативнее с мотивационными плакатами. Использовать причину смерти тысяч людей как источник мотивации? Гениально. Вот бы это ещё работало...
...
ent-PosterLegitGoobNTRAdvert = Рекрутинг NTRep
    .desc = Постер с объявлением о вакансиях представителей Нанотрейзен, может, стоит подать заявку.
...
ent-PosterContrabandGoobRedFOSS = Плакат «Red Tux»
    .desc = Плакат, называющий свободное открытое программное обеспечение коммунизмом. Ты не уверен, автор за это или против.
