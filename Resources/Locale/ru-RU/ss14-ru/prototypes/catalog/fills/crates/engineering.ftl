...
ent-CrateEngineeringElectricalSupplies = ящик электромонтажного снаряжения
    .desc = НТ не несёт ответственности за любые рабочие конфликты, связанные с изолированными перчатками, входящими в комплект этих ящиков.
...
ent-CrateEvaKit = набор ЕВА
    .desc = Набор, состоящий из двух престижных ЕВА скафандров и шлемов.
ent-CrateRCDAmmo = ящик зарядов РЦД
    .desc = 3 обоймы для РЦД, каждая из которых восстанавливает 5 зарядов.
ent-CrateRCD = ящик РЦД
...
ent-CrateRPD = ящик РПД
    .desc = Ящик, содержащий РПД.
