...
ent-CableMVStack = моток СВ-кабеля
    .suffix = Полный
    .desc = Моток средневольтных проводов для подключения подстанций к АПЦ, а также для питания некоторого оборудования, например, эмиттеров.
...
ent-CableApcStack = моток НВ-кабеля
    .desc = Моток низковольтных проводов для соединения АПЦ с устройствами, а также для других задач.
    .suffix = Полный
