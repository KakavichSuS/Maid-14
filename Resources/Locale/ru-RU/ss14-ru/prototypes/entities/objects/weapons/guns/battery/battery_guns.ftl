...
ent-WeaponDisablerSMG = дизейблер-пулемёт
    .desc = Усовершенствованное оружие, которое изнуряет органические цели, пока они не свалятся с ног. Некоторые называют его автодизейблер.
...
ent-WeaponTaserSuper = элитный тазер
    .desc = Маломощный энергетический пистолет, используемый элитными отрядами службы безопасности для обезвреживания даже самых крепких целей.
