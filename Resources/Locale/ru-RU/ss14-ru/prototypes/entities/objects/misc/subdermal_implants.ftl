...
ent-FakeMindShieldImplant = имплант "фальшивый Щит разума"
    .desc = Этот имплант позволяет имплантеру генерировать фальшивый сигнал, по которому охранные визоры НТ идентифицируют людей, имплантированных Щитом разума.
