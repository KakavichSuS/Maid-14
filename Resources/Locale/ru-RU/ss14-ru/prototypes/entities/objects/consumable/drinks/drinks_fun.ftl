...
ent-BottomlessLube = бездонная колба смазки
    .desc = Эта аномальная колба бесконечно производит космическую смазку и должна тщательно охраняться, чтобы не попасть в плохие руки.
