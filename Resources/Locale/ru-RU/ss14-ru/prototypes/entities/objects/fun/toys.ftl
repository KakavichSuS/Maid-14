...
ent-PlushieSpaceLizard = плюшевый космический унатх
    .desc = Очаровательная мягкая игрушка, напоминающая унатха в ЕВА скафандре. Изготовлена Центком в рамках показательной инициативы по борьбе с дискриминацией по видовому признаку в рабочей среде. "Приветствуйте своих новых коллег как вы приветствуете эту игрушку, с распростёртыми объятиями!".
...
ent-PonderingOrb = шар размышлений
    .desc = Затягивает, чувак... Очень затягивает.
...
ent-PlushieMoth = плюшевая моль
    .desc = Милый и пушистый плюшевая моль. Развлекайтесь, бз!
