...
ent-MobIfritGuardian = Ифрит
    .desc = Испорченный джинн, вырванный из Фитры, чтобы прислуживать магу в его низменных нуждах. Он стоит злой, настраиваясь на жизнь своего владельца, чтобы поддерживать себя.
...
ent-ActionSelfToggleGuardian = Вернуться в себя
    .desc = Возвращает вас обратно в тело вашего хозяина.
