...
tips-dataset-43 = Будучи ядерным оперативником, помните о скрытном варианте. Капитану будет сложнее отбиться, если его застанет врасплох тот, кого он считает обычным ассистентом
...
tips-dataset-61 = Будучи клоуном помните, что даже если вы потеряли свою банановую кожурку, то на вашем ПДА всё ещё можно поскользнуться! Хонк!
...
tips-dataset-136 = Если вы заперты за дверью под напряжением: отключите АПЦ или киньте ID-карту в дверь, чтобы избежать удара током!
...
tips-dataset-139 = Обязательно протирайте незаконные имплантанты с мылом или влажной тряпкой после их использования! Детективы могут сканировать использованные имплантанты на предмет наличия улик ДНК, но только в том случае, если они были тщательно вытерты.
