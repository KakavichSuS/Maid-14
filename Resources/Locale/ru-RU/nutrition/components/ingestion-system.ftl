...
ingestion-you-need-to-hold-utensil = Вам нужно держать {$utensil}, чтобы съесть это!

ingestion-try-use-is-empty = {CAPITALIZE(THE($entity))} пусто!
...
edible-swallow = Вы глотаете { THE($food) }
edible-gulp = Глоток. {$flavors}
edible-gulp-other = Глоток.

edible-has-used-storage = Вы не можете {$verb} { THE($food) }, так как внутри хранится предмет.
