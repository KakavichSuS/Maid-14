...
stack-wood-floor-bright-large = деревянный светлый пол
stack-wood-floor-parquet = деревянный паркет
stack-wood-floor-bright-parquet = деревянный светлый паркет
...
stack-wood-pattern-floor = деревянный узорчатый пол
...
stack-white-marble-floor = пол из белого мрамора
stack-dark-marble-floor = пол из тёмного мрамора
stack-plasma-marble-floor = пол из плазменного мрамора
