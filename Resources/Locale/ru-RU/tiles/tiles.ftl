...
tiles-dark-squiggly = плитка из волнистой тёмной стали
tiles-dirt-planet-floor = пол из планетарной земли
tiles-plasma-marble = плазма-мраморная плитка
tiles-techmaint-floor-dark = тёмный техобслуживаемый пол
tiles-uranium-marble = уран-мраморная плитка
tiles-white-marble = плитка из белого мрамора
tiles-xeno-floor = ксено-пол
tiles-xeno-maint = ксено-техобслуживание
