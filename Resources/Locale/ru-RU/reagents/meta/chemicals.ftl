...
reagent-name-artifact-glue = клей для артефактов
reagent-desc-artifact-glue = Смесь клея и артифексиума. При контакте восстанавливает прочность узлов артефакта.
