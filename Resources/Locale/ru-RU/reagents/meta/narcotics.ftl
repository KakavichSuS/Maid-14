...
reagent-desc-nitrosyl-plasmide = Мощный стимулятор, который предотвращает сонливость, оглушает и сбивает с ног.
