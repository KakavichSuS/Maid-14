...
uplink-hardsuit-syndiemedic-desc = Комплект с запасным боевым медиком-костюмом от мародёров Горлекса.
uplink-hardsuit-syndiecommander-name = Командирский боевой костюм Горлекс
uplink-hardsuit-syndiecommander-desc = Запасной командирский боевой костюм от мародёров Горлекса. Слишком громоздкий для комплекта, баллоны не входят!
...
uplink-syndicate-disabler-desc = Продвинутый дизейблер, созданный на основе прототипа Нанотрейзен. Хоть ему и не хватает мощности, это компенсируется самозаряжающейся батареей.
# MaidEnd
...
uplink-m90-ammo-name = Магазин для винтовки (.20 калибр)
uplink-m90-ammo-desc = Магазин на 25 патронов. Совместим с M-90 и Lecter.
...
uplink-mech-teleporter-heavy-desc = Содержит тяжёлый бронированный мех Киберсан с интегрированным мечом-пилой, Ultra AC-2, LBX AC 10 "Бессистемный", Ракетной установкой BRM-6 и Пушка P-X Тесла.
uplink-mech-teleporter-assault-name = Телепорт штурмового меха
uplink-mech-teleporter-assault-desc = Содержит лёгкий бронированный мех Киберсан с интегрированным мечом-пилой, LBX AC 10 "Бессистемный", лёгкой ракетной установкой SRM-8 и Пушка P-X Тесла.
...
uplink-autosurgeon-statveka-sandevistan-name = Автооперация (сандевистан Statveka)
uplink-autosurgeon-statveka-sandevistan-desc = Заменяет сердце пользователя на сандевистан Statveka — синтетический орган, который значительно увеличивает скорость и рефлексы пользователя ценой выносливости. В отличие от обычного, этот, кажется, замедляет время вокруг пользователя. Поставляется с одноразовой автооперацией для установки.

uplink-autosurgeon-smartlink-name = Автооперация (смартлинк)
uplink-autosurgeon-smartlink-desc = Модифицирует руки пользователя, добавляя имплант «смартлинк», улучшающий меткость при стрельбе. Требует слишком тонкой настройки, поэтому поставляется с одноразовой автооперацией.

uplink-autosurgeon-recoil-absorbing-name = Автооперация (поглощение отдачи)
uplink-autosurgeon-recoil-absorbing-desc = Модифицирует руки пользователя, добавляя имплант поглощения отдачи, значительно снижающий отдачу при стрельбе. Требует слишком тонкой настройки, поэтому поставляется с одноразовой автооперацией.

uplink-autosurgeon-berserker-heart-name = Автооперация (сердце берсерка)
uplink-autosurgeon-berserker-heart-desc = Заменяет сердце пользователя на имплант берсерка, позволяющий войти в состояние берсерка, значительно увеличивая урон в ближнем бою и скорость, а также предотвращая критический урон. Требует слишком тонкой настройки, поэтому поставляется с одноразовой автооперацией.

uplink-autosurgeon-jumpstarter-heart-name = Автооперация (сердце-стартер)
uplink-autosurgeon-jumpstarter-heart-desc = Заменяет сердце пользователя на имплант-стартер, который впрыскивает достаточно омнизина для подъёма при критическом уроне. Перезарядка 3 минуты. Требует слишком тонкой настройки, поэтому поставляется с одноразовой автооперацией.
...
uplink-guerrilla-gloves-desc = Специальная пара перчаток с защитой от удара током, которые по умолчанию делают захват сильным, снижают замедление при захвате и затрудняют жертве побег из захвата.
...
uplink-carpcaller-name = Призыватель космических карпов
uplink-carpcaller-desc = Устройство, эксплуатирующее психологию карпов: будучи закреплённым, запитанным и открытым космосу, привлекает диких космических карпов. Имей в виду, ты им не друг.
...
uplink-adv-mimery-name = Серия продвинутой пантомимы
uplink-adv-mimery-desc = Классическая двухчастная серия о том, как отточить навыки мима. Изучив серию, пользователь сможет создавать невидимые стены 3x1 и стрелять пулями из пальцев.

uplink-grey-tide-name = Серый прилив
uplink-grey-tide-desc = Древний артефакт с магическими свойствами. Идентичен плазменному копью, но способен призывать иллюзии при ударе по живой цели, если владелец — ассистент.

uplink-bloodred-cassette-name = Кроваво-красный кассетный плеер
uplink-bloodred-cassette-desc = Созданный самыми самовлюблёнными модельерами Киберсан, портативный музыкальный плеер!

uplink-syndiedrobe-name = Синдигардероб
uplink-syndiedrobe-desc = Торговый автомат с одеждой бренда Синдиката. Простой, стильный и неизменно красно-чёрный, предлагающий оперативникам одеваться в стиле Синдиката.

uplink-customboard-name = Кастомная плата законов Синдиката
uplink-customboard-desc = Модифицированная плата законов, позволяющая пользователю менять законы на любые по своему желанию. Поставляется с предустановленным Антимовым.

uplink-box-xenobio-name = Ящик ксенобиологических слаймов
uplink-box-xenobio-desc = Слаймы для ваших ксенобиологических нужд. Содержит 9 случайных слаймов T1.

# Contractor

uplink-moduist-contractor-name = Модсьют контрактника
uplink-moduist-contractor-desc = Этот лёгкий модсьют создан специально для Гильдии! Сделан из пластитаниума для экстремальной прочности, оснащён сервоприводами для усиления захвата, инжекторами критического урона и встроенной технологией хамелеона! Чтобы сохранить сверхлёгкий вес, модсьют не имеет возможности хранения.

uplink-hardsuit-contractor-name = Комплект скафандра контрактника
uplink-hardsuit-contractor-desc = Этот лёгкий скафандр создан специально для Гильдии! Легко складывается в рюкзак.

uplink-webbing-contractor-name = Разгрузка контрактника
uplink-webbing-contractor-desc = Нагрудная разгрузка с глубокими карманами и взрывоустойчивостью, часто используемая контрактниками и охотниками за головами.

uplink-jetpack-contractor-name = Реактивный ранец контрактника
uplink-jetpack-contractor-desc = Этот реактивный ранец создан специально для Гильдии! Обладает высокой манёвренностью и приличным запасом топлива, идеален для быстрого побега. Имеет встроенные ремни для совместимости с хранением на костюме.

uplink-cuffs-contractor-name = Наручники
uplink-cuffs-contractor-desc = Используются для задержания преступников и прочих мудаков.
