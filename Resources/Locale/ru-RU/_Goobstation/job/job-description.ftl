...
job-description-navy-special-operations-officer = Отправляйте, инструктируйте и руководите командами экстренного реагирования или другими силами Нанотрейзен. Выпускайте ядерные коды — или нет.
...
job-description-roboticist = Стройте и обслуживайте боргов и мехов. Следите за ИИ.

# Viro
job-description-virologist = Изучайте распространяющиеся вирусы, создавайте лекарства для больных членов экипажа, экспериментируйте с созданием полезных вирусов. Следите, чтобы пандемии не распространялись.
