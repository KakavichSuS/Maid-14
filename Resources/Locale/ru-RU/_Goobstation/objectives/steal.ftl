...
objective-condition-steal-gemini-projector-description = Если Директор Исследований использует его, вам придётся выковыривать его из его позвоночника. Рекомендуем устроить отвлечение и обезвредить его.
