...
krav-maga-ready = Ты готовишь { $action }
martial-arts-action-sender = Ты ударил { $name } { $move }
...
hellrip-success-learned = Вы освоили Хелл Рипте. Свиток сгорает у вас в руках...
