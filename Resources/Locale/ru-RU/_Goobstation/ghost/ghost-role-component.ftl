...
ghost-role-information-special-operations-officer-description = Отправляй, инструктируй и управляй командами экстренного реагирования и другими силами Нанотрейзен. Освободи ядерные коды — или нет.
...
ghost-role-information-navy-officer-undercover-description = Выполняй задачи и ликвидируй назначенные цели. Удачи.
ghost-role-information-navy-officer-undercover-rules = Следуй приказам [color=#yellow][bold]Капитана ВМС[/bold][/color] или другого представителя Центрального Командования.
ghost-role-information-diplomat-name = Представитель Центрального Командования
ghost-role-information-diplomat-description = Представляй Центральное Командование, управляй отношениями с другими фракциями на станции. Устраняй проблемы, вызванные капитаном.
...
ghost-role-information-Gman-rules = Ты не подчиняешься никаким правилам или ограничениям. Смерть не властна над тобой, как и Нанотрейзен.

# Shuttle roles

ghost-role-information-alien-tourist-name = Инопланетный Турист
ghost-role-information-alien-tourist-description = Осматривай станцию. Пялься на людей. Получи пулю от офицера с коротким поводком.
...
roles-wizard-name-token = Ман (Токен)
...
ghost-role-information-wraith-name-token = Рейф (Токен)
ghost-role-information-slasher-token = Резчик (Токен)
ghost-role-information-contractor-name = Подрядчик Синдиката
ghost-role-information-contractor-token = Подрядчик Синдиката (Токен)
ghost-role-information-contractor-description = ВЗЯТЬ ЭТОГО... тайдера..?
contractor-role-greeting = Ты — [color=#611b2b]Подрядчик Синдиката[/color], охотник за головами. Твоя задача — доставить цели со станции, мёртвыми или живыми.
ghost-role-information-plague-mouse-name = Чумная Мышь
ghost-role-information-plague-mouse-description = Голодная и озорная мышь. Эта особь переносит болезнь, которая передаётся при укусе.
ghost-role-information-rules-default-xeno = Ты — [color={role-type-team-antagonist-color}][bold]Ксеноморф[/bold][/color].
                                            Твоя цель — защищать Королеву и расширять Улей.
                                            Приводи к Королеве членов экипажа для заражения, чтобы достичь этого.
ghost-role-information-sentientanimal-rules = Ты — [color={role-type-sentient-animal-color}][bold]{role-type-sentient-animal-name}[/bold][/color]. Ты нейтральное животное, которое может действовать в целях самообороны, но не должно намеренно вредить экипажу.
                                              Ты не помнишь свою прошлую жизнь и ничего из того, что узнал(а) будучи призраком.
                                              Ты можешь помнить общие знания об игре: как готовить, как пользоваться предметами и т.д., но ты не разбираешься в продвинутых ролях.
                                              Тебе категорически [color=red]НЕЛЬЗЯ[/color] помнить, например, имя, внешность и т.д. своего прошлого персонажа.
