...
reagent-desc-triclor = Реплицируется при контакте с кровью и заставляет метаболизатора постоянно рвать, быстро опустошая желудок и прочее. Имеет относительно низкую силу, для убийства нужны высокие дозы. Неэффективен в следовых количествах.
...
reagent-desc-microplastics = Слаботоксичный загрязнитель, содержащийся во многих предметах повседневного обихода. Его токсические эффекты, похоже, не действуют на Воксов.
