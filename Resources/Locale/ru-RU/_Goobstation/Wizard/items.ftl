...
teleport-scroll-no-charges = Свиток истратил заряды и рассыпался в прах!
sanguine-strike-end = { CAPITALIZE($item) } кажется теряет своё красное свечение.
sanguine-strike-examine = [color=#c41515]Это оружие усилено кровавой магией.[/color]
...
wizard-mirror-blood-crawl-change-species-fail = Вы не можете сменить расу после использования демонического сердца!
