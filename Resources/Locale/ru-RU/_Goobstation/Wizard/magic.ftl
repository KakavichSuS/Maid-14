...
spell-fail-target-silicon = Нельзя применять на силиконах.
...
spell-fail-bind-soul-silicon = Нельзя связать душу в форме силикона!
spell-fail-mutate-silicon = Нельзя мутировать в форме силикона!
spell-fail-tesla-blast = Вы теряете контроль над молнией!
spell-fail-lightning-bolt = Нельзя выпустить молнию туда.
...
spell-fail-mindswap-ghoul = Нельзя менять сознание с гульём!
...
spell-fail-mindswap-dead = Вы не особенно хотите быть мёртвым!
spell-requirements-failed-clothes = Для заклинания нужны мантию и шляпа мага.
spell-requirements-failed-speech = Для заклинания нужно говорить.
instant-summons-item-marked = { $item } успешно отмечен.
instant-summons-confirm-popup = Это действие удалит текущую отметку! Используйте ещё раз для подтверждения.
chuuni-invocation-confirm-popup = Это действие заставит вас носить неизъятную повязку на глаз! Используйте ещё раз для подтверждения.
...
spell-charge-spells-charged-pulled = Вы чувствуете, как сырая магия течёт через вас. Это приятно!
...
spell-summon-simians-maxed-out-message = Ваша сила приматов достигла максимума! Теперь вы можете кастовать это заклинание голым, а также получили заклинание превращения в гориллу!
