...
job-description-command-maid = Убирайте мостик, командные отсеки и всё остальное, что прикажет командование.
job-description-security-clown = Делайте работу СБ, но не забывайте делать это с клоунской изюминкой.
job-description-party-maker = Устройте самую большую вечеринку на этой станции!
