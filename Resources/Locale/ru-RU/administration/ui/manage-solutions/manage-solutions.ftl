...
admin-solutions-window-solution-button-tooltip = Открывает соответствующий серверный экземпляр раствора в ViewVariables. Полезно для отладки проблем с предсказанием.
